...
<template>
  ...
  <div style="height: calc(100vh - 200px - 0.5em)">
    <vxe-table :menu-config="{}" ref="tableRef" height="100%" show-overflow :data="listing">
      ...
      <vxe-column field="address" title="设备编号"></vxe-column>
      <vxe-column field="created_at" title="报废原因"></vxe-column>
      <vxe-column field="created_at" title="报废时间"></vxe-column>
      <vxe-column field="created_at" title="操作人"></vxe-column>
      <vxe-column field="created_at" title="备注"></vxe-column>
      <vxe-column field="created_at" title="图片"></vxe-column>
