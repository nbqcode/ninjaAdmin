...
<template>
  ...
  <div style="height: calc(100vh - 200px - 0.5em)">
    <vxe-table :menu-config="{}" show-header-overflow ref="tableRef" height="100%" show-overflow :data="listing">
      ...
      <vxe-column field="name" title="品牌型号"></vxe-column>
      <vxe-column field="name" title="单位名称"></vxe-column>
      <vxe-column field="name" title="设备状态"></vxe-column>
      <vxe-column field="name" title="设备使用人"></vxe-column>
      <vxe-column field="name" title="使用人电话"></vxe-column>
      <vxe-column field="name" title="短信提醒"></vxe-column>
      <vxe-column field="name" title="设备分类"></vxe-column>
      <vxe-column field="name" title="使用部门"></vxe-column>
      <vxe-column field="name" title="购买/租赁时间"></vxe-column>
      <vxe-column field="name" title="过保/到期时间"></vxe-column>
      <vxe-column field="name" title="放置区域"></vxe-column>
      <vxe-column field="name" title="备注"></vxe-column>
      <vxe-column field="name" title="设备码"></vxe-column>
      <vxe-column :visible="false" field="created_at" title="创建时间"></vxe-column>
      <vxe-column :visible="false" field="updated_at" title="修改时间"></vxe-column>
